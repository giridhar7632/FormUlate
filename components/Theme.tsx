    ...
    <Popover className={'relative'}>
      {({ open }) => (
        <>
          ...
          >
            <Popover.Panel className="absolute right-0 z-10 mt-3 w-36 transform  rounded-lg bg-white dark:bg-gray-800 px-4 sm:px-0 lg:max-w-3xl dark:border dark:border-gray-600">
