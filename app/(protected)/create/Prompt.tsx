...
const Prompt =  () => {
    ...
    return (
        <form ref={formRef} className="w-full flex flex-col items-center justify-center" action={async (formData) => {
            ...
            placeholder="I need a form to collect user feedback for my product. The form should have fields for collecting the user data like name, email, gender and their valuable feedback ..." className={clsx([
            ...
            <Button className="w-48" type="submit">Generate</Button>
        </form>
    )
}
