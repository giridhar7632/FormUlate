    ...
    <Popover className="relative">
      {({ open }) => (
        <>
          ...
          >
            <PopoverPanel className="absolute right-0 z-10 mt-3 w-52 transform  rounded-xl bg-white dark:bg-gray-800 sm:px-0 lg:max-w-3xl dark:border dark:border-gray-600">
              <div className="overflow-hidden rounded-xl shadow-lg ring-1 ring-black ring-opacity-5">
                ...
                <DeleteButton slug={slug} id={id} removeForm={removeForm} />
              </div>
            </PopoverPanel>
          </Transition>
        </>
